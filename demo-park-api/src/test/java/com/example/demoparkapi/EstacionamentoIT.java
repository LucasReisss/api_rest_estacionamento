...
public class EstacionamentoIT {
    ...
    @Test
    public void buscarCheckin_ComReciboInexistente_RetornarDadosStatus400() {
    ...
    @Test
    public void cbuscarEstacionamentos_PorClienteCpfComPerfilCliente_RetornarErroStatus403() {
    ...
    public void buscarEstacionamentos_DoClienteLogado_RetornarSucesso() {
        ...
        testClient.get().uri("/api/v1/estacionamentos?size=1&page=1")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bob@email.com.br", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(PageableDto.class)
    ...
    @Test
    public void cbuscarEstacionamentos_DoClienteLogadoPerfilAdmin_RetornarErroStatus403() {
