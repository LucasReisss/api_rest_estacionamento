...
import com.example.demoparkapi.web.dto.UsuarioCreateDto;
import com.example.demoparkapi.web.dto.UsuarioResponseDto;
import com.example.demoparkapi.web.dto.UsuarioSenhaDto;
...
public class UsuarioIT {
    ...
    @Test
    public  void createUsuario_ComUsernameEPasswordValidos_RetornarUsuariosCriadosComStatus201() {
    ...
    @Test
    public  void buscarUsuario_ComIdExistente_RetornarUsuarioCriadosComStatus200() {
        UsuarioResponseDto responseBody = testClient
                .get()
    ...
    @Test
    public  void editarSenha_ComCampusInvalidos_RetornarErrorMessageComStatus422() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
    ...
    @Test
    public void listarUsuarios_ComUsuariosSemPermissao_RetornarListaDeUsuariosComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/usuarios")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
