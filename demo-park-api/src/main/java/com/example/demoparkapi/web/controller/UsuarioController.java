...
import com.example.demoparkapi.web.dto.mapper.UsuarioMapper;
...
@Tag(name = "Usuarios", description = "Contém todas as operações relativas aos recursos para cadrastro, edição e leitura de um usuário.")
