...
import com.example.demoparkapi.service.VagaService;
import com.example.demoparkapi.web.dto.ClienteCreateDto;
import com.example.demoparkapi.web.dto.VagaCreateDto;
import com.example.demoparkapi.web.dto.VagaResponseDto;
import com.example.demoparkapi.web.dto.mapper.VagaMapper;
...
public class VagaController {
    ...
    @Operation(summary = "Criar uma novo vaga", description = "Recurso para criar uma nova vaga" +
    ...
    @Operation(summary = "Localizar uma vaga", description = "Recurso para retornar uma vaga pelo seu código" +
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recurso criado com sucesso",
                            content = @Content(mediaType = "application/json;charset=UTF8", schema = @Schema(implementation = VagaResponseDto.class))),
