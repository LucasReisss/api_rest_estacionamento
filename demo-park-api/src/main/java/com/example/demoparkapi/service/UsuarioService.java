...
import com.example.demoparkapi.exception.UsernameUniqueViolationException;
import com.example.demoparkapi.repository.UsuarioRepository;
import com.example.demoparkapi.web.exception.PasswordInvalidException;
...
public class UsuarioService {
    ...
    public Usuario editarSenha(Long id, String senhaAtual, String novaSenha, String confirmaSenha) {
        if(!novaSenha.equals(confirmaSenha)) {
            throw new PasswordInvalidException("Nova senha confere com confirmação de senha.");
        }
