...
import com.example.demoparkapi.exception.CpfUniqueViolationException;
import com.example.demoparkapi.exception.EntityNotFoundException;
import com.example.demoparkapi.repository.ClienteRepository;
...
public class ClienteService {
    ...
    public Cliente buscarPorCpf(String cpf) {
        return clienteRepository.findByCpf(cpf).orElseThrow(
                () -> new EntityNotFoundException(String.format("Cliente com CPF '%s' não enocntrado", cpf))
        );
    }
}
